...
class ItemController extends Controller
{
    ...
    {
        if(!Helpers::get_delivery_company_data()->item_section)
        {
            Toastr::warning(translate('messages.permission_denied'));
            return back();
        }
        $categories = Category::where(['position' => 0])->module(Helpers::get_delivery_company_data()->module_id)->get();
        $module_data = config('module.'. Helpers::get_delivery_company_data()->module->module_type);
        return view('delivery-partner-views.product.index', compact('categories','module_data'));
    }

    public function delivery_company(Request $request): JsonResponse
    {
        if(!Helpers::get_delivery_company_data()->item_section)
        {
        ...
        $food->delivery_company_id = Helpers::get_delivery_company_id();
        $food->module_id = Helpers::get_delivery_company_data()->module_id;
        $food->images = $images;
    ...
    public function view($id)
    {
        ...
        return view('delivery-partner-views.product.view', compact('product','reviews'));
    }
    ...
    public function edit($id)
    {
        ...
        $categories = Category::where(['parent_id' => 0])->module(Helpers::get_delivery_company_data()->module_id)->get();
        $module_data = config('module.'. Helpers::get_delivery_company_data()->module->module_type);
        return view('delivery-partner-views.product.edit', compact('product', 'product_category', 'categories','module_data'));
    }
    ...
    public function variant_combination(Request $request)
    {
        ...
        return response()->json([
            'view' => view('delivery-partner-views.product.partials._variant-combinations', compact('combinations', 'price', 'product_name','stock'))->render(),
    ...
    public function list(Request $request)
    {
        ...
        return view('delivery-partner-views.product.list', compact('items', 'category', 'type'));
    }
    ...
    public function search(Request $request){
        ...
        return response()->json([
            'view'=>view('delivery-partner-views.product.partials._table',compact('items'))->render(),
            'count'=>$items->count()
        ]);
    }
    ...
    {
        return view('delivery-partner-views.product.bulk-import');
    }
    ...
    {
        return view('delivery-partner-views.product.bulk-export');
    }
    ...
    public function stock_limit_list(Request $request)
    {
        ...
        ->type($type)->latest()->paginate(config('default_pagination'));
        $category =$category_id !='all'? Category::findOrFail($category_id):null;
        return view('delivery-partner-views.product.stock_limit_list', compact('items', 'category', 'type'));
    ...
    public function get_variations(Request $request)
    {
        ...
        return response()->json([
            'view' => view('delivery-partner-views.product.partials._update_stock', compact('product'))->render()
        ]);
    }
