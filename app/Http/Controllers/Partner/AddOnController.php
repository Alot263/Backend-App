...
class AddOnController extends Controller
{
    public function index()
    {
        ...
        return view('delivery-partner-views.addon.index', compact('addons'));
    }
    ...
    public function delivery_company(Request $request): RedirectResponse
    {
        ...
        $addon->delivery_company_id = \App\CentralLogics\Helpers::get_delivery_company_id();
        $addon->save();
        $data = [];
    ...
    public function edit($id)
    {
        ...
        return view('delivery-partner-views.addon.edit', compact('addon'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect(route('partner.addon.add-new'));
    }
