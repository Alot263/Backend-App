...
class DeliveryManController extends Controller
{
    ...
    {
        return view('delivery-partner-views.delivery-man.index');
    }

    public function list(Request $request)
    {
        $delivery_men = DeliveryMan::where('delivery_company_id', Helpers::get_delivery_company_id())->latest()->paginate(config('default_pagination'));
        return view('delivery-partner-views.delivery-man.list', compact('delivery_men'));
    }
    ...
    public function search(Request $request): JsonResponse
    {
        ...
        })->where('delivery_company_id', Helpers::get_delivery_company_id())->get();
        return response()->json([
            'view'=>view('delivery-partner-views.delivery-man.partials._table',compact('delivery_men'))->render(),
    ...
    public function reviews_list(){
        ...
        return view('delivery-partner-views.delivery-man.reviews-list',compact('reviews'));
    }

    public function preview($id, $tab='info')
    {
        $dm = DeliveryMan::with(['reviews'])->where('delivery_company_id', Helpers::get_delivery_company_id())->where(['id' => $id])->first();
        if($tab == 'info')
        {
            $reviews=DMReview::where(['delivery_man_id'=>$id])->latest()->paginate(config('default_pagination'));
            return view('delivery-partner-views.delivery-man.view.info', compact('dm', 'reviews'));
        }
        else if($tab == 'transaction')
        {
            return view('delivery-partner-views.delivery-man.view.transaction', compact('dm'));
        }
    }
    ...
    public function delivery_company(Request $request): JsonResponse
    {
        ...
        $dm->delivery_company_id =  Helpers::get_delivery_company_id();
        ...
        return redirect('delivery_company-panel/delivery-man/list');
    }

    public function edit($id)
    {
        $delivery_man = DeliveryMan::find($id);
        return view('delivery-partner-views.delivery-man.edit', compact('delivery_man'));
    }
    ...
    public function get_deliverymen(Request $request){
        ...
        })->where('delivery_company_id', Helpers::get_delivery_company_id())->limit(8)->get(['id',DB::raw('CONCAT(f_name, " ", l_name) as text')]);
    ...
    public function transaction_search(Request $request){
        ...
        return response()->json([
            'view'=>view('delivery-partner-views.delivery-man.partials._transation',compact('digital_transaction'))->render(),
