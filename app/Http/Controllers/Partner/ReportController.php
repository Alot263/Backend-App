...
class ReportController extends Controller
{
    ...
    public function expense_report(Request $request)
    {
        ...
        $expense = Expense::with('order')->where('created_by','partner')->where('delivery_company_id',Helpers::get_delivery_company_id())
        ...
        return view('delivery-partner-views.report.expense-report', compact('expense','from','to','filter'));
    }
