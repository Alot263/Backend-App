...
class DeliveryManController extends Controller
{
    public function __construct(Request $request)
    {
        $this->middleware(function ($request, $next) {
            if(!$request->partner->delivery_companies[0]->self_delivery_system)
            {
    ...
    public function list(Request $request): JsonResponse
    {
        ...
        ->where('delivery_company_id', $request->partner->delivery_companies[0]->id)->latest()->get()->map(function($data){
    ...
    public function search(Request $request): JsonResponse
    {
        ...
        })->where('delivery_company_id', $request->partner->delivery_companies[0]->id)->limit(50)->get();
    ...
    public function preview(Request $request)
    {
        ...
        ->where('delivery_company_id', $request->partner->delivery_companies[0]->id)->where(['id' => $request->delivery_man_id])->first();
    ...
    public function delivery_company(Request $request): JsonResponse
    {
        ...
        $dm->delivery_company_id =  $request->partner->delivery_companies[0]->id;
