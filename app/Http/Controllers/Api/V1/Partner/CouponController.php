...
class CouponController extends Controller
{
    public function list(Request $request): JsonResponse
    {
        ...
        $storage = [];
        $coupons = Coupon::latest()->where('created_by', 'partner')->where('delivery_company_id',$delivery_company_id)
    ...
    public function delivery_company(Request $request): JsonResponse
    {
        ...
        DB::table('coupons')->insert([
            ...
            'module_id' => $request->partner->delivery_companies[0]->module_id,
            'created_at' => now(),
            'updated_at' => now()
        ]);
    ...
    public function update(Request $request): JsonResponse
    {
        ...
        DB::table('coupons')->where(['id' => $request->coupon_id])->where('created_by', 'partner' )->where('delivery_company_id',$delivery_company_id)
        ->update([
            'title' => $request->title,
            'code' => $request->code,
            'limit' => $request->coupon_type=='first_order'?1:$request->limit,
    ...
    public function status(Request $request): JsonResponse
    {
        ...
        $coupon = Coupon::where(['id' => $request->coupon_id])->where('created_by', 'partner' )->where('delivery_company_id',$delivery_company_id)->first();
    ...
    public function search(Request $request): JsonResponse
    {
        ...
        })->where('created_by', 'partner' )->where('delivery_company_id',$delivery_company_id)
        ->paginate($limit, ['*'], 'page', $offset);
        $data = [
