...
Route::group(['namespace' => 'Partner', 'as' => 'partner.'], function () {
    ...
    Route::group(['middleware' => ['partner']], function () {
        ...
        Route::get('/get-delivery-company-data', 'DashboardController@delivery_company_data')->name('get-delivery-company-data');
        Route::post('/delivery-company-token', 'DashboardController@updateDeviceToken')->name('delivery-company.token');
        Route::get('/reviews', 'ReviewController@index')->name('reviews')->middleware('module:reviews');
        Route::get('site_direction', 'BusinessSettingsController@site_direction_partner')->name('site_direction');
        ...
        Route::group(['prefix' => 'pos', 'as' => 'pos.'], function () {
            ...
            Route::group(['middleware' => ['module:pos']], function () {
                ...
                Route::post('customer-delivery-company', 'POSController@customer_delivery_company')->name('customer-delivery-company');
        ...
        Route::group(['prefix' => 'custom-role', 'as' => 'custom-role.', 'middleware' => ['module:custom_role']], function () {
            ...
            Route::post('create', 'CustomRoleController@delivery_company')->name('delivery-company');
        ...
        Route::group(['prefix' => 'delivery-man', 'as' => 'delivery-man.', 'middleware' => ['module:deliveryman']], function () {
            ...
            Route::post('delivery-company', 'DeliveryManController@delivery_company')->name('delivery-company');
        ...
        Route::group(['prefix' => 'employee', 'as' => 'employee.', 'middleware' => ['module:employee']], function () {
            ...
            Route::post('add-new', 'EmployeeController@delivery_company');
        ...
        Route::group(['prefix' => 'item', 'as' => 'item.', 'middleware' => ['module:item']], function () {
            ...
            Route::post('delivery-company', 'ItemController@delivery_company')->name('delivery-company');
        ...
        Route::group(['prefix' => 'campaign', 'as' => 'campaign.', 'middleware' => ['module:campaign']], function () {
            ...
            Route::get('remove-delivery-company/{campaign}/{delivery_company}', 'CampaignController@remove_delivery_company')->name('remove-delivery-company');
            Route::get('add-delivery-company/{campaign}/{delivery_company}', 'CampaignController@add_delivery_company')->name('add-delivery-company');
        ...
        Route::group(['prefix' => 'coupon', 'as' => 'coupon.', 'middleware' => ['module:coupon']], function () {
            ...
            Route::post('delivery-company', 'CouponController@delivery_company')->name('delivery-company');
        ...
        Route::group(['prefix' => 'addon', 'as' => 'addon.', 'middleware' => ['module:addon']], function () {
            ...
            Route::post('delivery-company', 'AddOnController@delivery_company')->name('delivery-company');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:delivery_company_setup']], function () {
            Route::get('delivery-company-setup', 'BusinessSettingsController@delivery_company_index')->name('delivery-company-setup');
            Route::post('add-schedule', 'BusinessSettingsController@add_schedule')->name('add-schedule');
            Route::get('remove-schedule/{delivery_company_schedule}', 'BusinessSettingsController@remove_schedule')->name('remove-schedule');
            Route::get('update-active-status', 'BusinessSettingsController@active_status')->name('update-active-status');
            Route::post('update-setup/{delivery_company}', 'BusinessSettingsController@delivery_company_setup')->name('update-setup');
            Route::get('toggle-settings-status/{delivery_company}/{status}/{menu}', 'BusinessSettingsController@delivery_company_status')->name('toggle-settings');
        });
        ...
        Route::group(['prefix' => 'delivery-company', 'as' => 'shop.', 'middleware' => ['module:my_delivery_company']], function () {
        ...
        Route::group(['prefix' => 'message', 'as' => 'message.'], function () {
            ...
            Route::post('delivery-company/{user_id}/{user_type}', 'ConversationController@delivery_company')->name('delivery-company');
