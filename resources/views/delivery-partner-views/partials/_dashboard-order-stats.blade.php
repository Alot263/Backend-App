<div class="col-sm-6 col-lg-3">
    <!-- Card -->
    <a class="resturant-card dashboard--card card--bg-1" href="{{route('partner.order.list',['confirmed'])}}">
...
<div class="col-sm-6 col-lg-3">
    <!-- Card -->
    <a class="resturant-card dashboard--card card--bg-2" href="{{route('partner.order.list',['cooking'])}}">
...
<div class="col-sm-6 col-lg-3">
    <!-- Card -->
    <a class="resturant-card dashboard--card card--bg-3" href="{{route('partner.order.list',['ready_for_delivery'])}}">
...
<div class="col-12">
    <div class="row g-2">
        ...
        <div class="col-sm-6 col-lg-3">
            <a class="order--card h-100" href="{{route('partner.order.list',['refunded'])}}">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
        ...
        <div class="col-sm-6 col-lg-3">
            <a class="order--card h-100" href="{{route('partner.order.list',['scheduled'])}}">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
