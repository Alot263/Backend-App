    ...
    <div class="content container-fluid config-inline-remove-class">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{translate('messages.delivery_company')}} {{translate('messages.setup')}}
                </span>
            </h1>
        </div>
        <!-- Page Heading -->
            ...
            <div class="card-body py-3">
                <div class="d-flex flex-row justify-content-between align-items-center">
                    <h4 class="card-title align-items-center d-flex">
                        <img src="{{asset('public/assets/admin/img/delivery_company.png')}}" class="w--20 mr-1" alt="">
                        <span>{{translate('messages.delivery_company_temporarily_closed_title')}}</span>
                    </h4>
                    <label class="switch toggle-switch-lg m-0">
                        <input type="checkbox" class="toggle-switch-input" onclick="restaurant_open_status(this)"
                            {{$delivery_company->active ?'':'checked'}}>
        ...
        <div class="card mb-3">
            <div class="card-header">
                <h5 class="card-title">
                    ...
                    <span>
                        {{translate('messages.delivery_company')}} {{translate('messages.settings')}}
                    </span>
                </h5>
            </div>
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="form-group mb-0">
                            <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border border-secondary rounded px-4 form-control" for="schedule_order">
                                ...
                                <input type="checkbox" class="toggle-switch-input" onclick="location.href='{{route('partner.business-settings.toggle-settings',[$delivery_company->id,$delivery_company->schedule_order?0:1, 'schedule_order'])}}'" id="schedule_order" {{$delivery_company->schedule_order?'checked':''}}>
                                <span class="toggle-switch-label">
                                    <span class="toggle-switch-indicator"></span>
                                </span>
                            </label>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="form-group mb-0">
                            <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border border-secondary rounded px-4 form-control" for="delivery">
                                ...
                                <input type="checkbox" name="delivery" class="toggle-switch-input" onclick="location.href='{{route('partner.business-settings.toggle-settings',[$delivery_company->id,$delivery_company->delivery?0:1, 'delivery'])}}'" id="delivery" {{$delivery_company->delivery?'checked':''}}>
                                <span class="toggle-switch-label">
                                    <span class="toggle-switch-indicator"></span>
                                </span>
                            </label>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="form-group mb-0">
                            <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border border-secondary rounded px-4 form-control" for="take_away">
                                ...
                                <input type="checkbox" class="toggle-switch-input" onclick="location.href='{{route('partner.business-settings.toggle-settings',[$delivery_company->id,$delivery_company->take_away?0:1, 'take_away'])}}'" id="take_away" {{$delivery_company->take_away?'checked':''}}>
                                <span class="toggle-switch-label">
                                    <span class="toggle-switch-indicator"></span>
                                </span>
                            </label>
                    ...
                    @php($prescription_order_status = $prescription_order_status ? $prescription_order_status->value : 0)
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="form-group mb-0">
                                    <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border border-secondary rounded px-4 form-control" for="prescription_order">
                                        ...
                                        <input type="checkbox" class="toggle-switch-input" onclick="location.href='{{route('partner.business-settings.toggle-settings',[$delivery_company->id,$delivery_company->prescription_order?0:1, 'prescription_order'])}}'" id="prescription_order" {{$delivery_company->prescription_order?'checked':''}}>
                                        <span class="toggle-switch-label">
                                            <span class="toggle-switch-indicator"></span>
                                        </span>
                                    </label>
                        ...
                        @endif
                    @endif
                    @if ($delivery_company->self_delivery_system == 1)
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group m-0">
                            <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border rounded px-3 form-control" for="free_delivery">
                                ...
                                <input type="checkbox" name="free_delivery" class="toggle-switch-input" onclick="location.href='{{route('partner.business-settings.toggle-settings',[$delivery_company->id,$delivery_company->free_delivery?0:1, 'free_delivery'])}}'" id="free_delivery" {{$delivery_company->free_delivery?'checked':''}}>
                                <span class="toggle-switch-label">
                                    <span class="toggle-switch-indicator"></span>
                                </span>
                            </label>
                    ...
                    @endif
                    @if ($toggle_veg_non_veg && config('module.'.$delivery_company->module->module_type)['veg_non_veg'])
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="form-group mb-0">
                            <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border border-secondary rounded px-4 form-control" for="veg">
                                ...
                                <input type="checkbox" class="toggle-switch-input" onclick="location.href='{{route('partner.business-settings.toggle-settings',[$delivery_company->id,$delivery_company->veg?0:1, 'veg'])}}'" id="veg" {{$delivery_company->veg?'checked':''}}>
                                <span class="toggle-switch-label">
                                    <span class="toggle-switch-indicator"></span>
                                </span>
                            </label>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="form-group mb-0">
                            <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border border-secondary rounded px-4 form-control" for="non_veg">
                                ...
                                <input type="checkbox" class="toggle-switch-input" onclick="location.href='{{route('partner.business-settings.toggle-settings',[$delivery_company->id,$delivery_company->non_veg?0:1, 'non_veg'])}}'" id="non_veg" {{$delivery_company->non_veg?'checked':''}}>
                                <span class="toggle-switch-label">
                                    <span class="toggle-switch-indicator"></span>
                                </span>
                            </label>
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <form action="{{route('partner.business-settings.update-setup',[$delivery_company['id']])}}" method="post"
                    ...
                    <div class="row">
                        <div class="form-group mb-0 col-md-4">
                            ...
                            <input type="number" name="minimum_order" step="0.01" min="0" max="100000" class="form-control" placeholder="100" value="{{$delivery_company->minimum_order??'0'}}" required>
                        </div>
                        @if (config('module.'.$delivery_company->module->module_type)['order_place_to_schedule_interval'])
                        <div class="form-group mb-0 col-md-4">
                        ...
                        <div class="form-group mb-0 col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" name="minimum_delivery_time" class="form-control" placeholder="Min: 10" value="{{explode('-',$delivery_company->delivery_time)[0]}}" title="{{translate('messages.minimum_delivery_time')}}">
                                <input type="number" name="maximum_delivery_time" class="form-control" placeholder="Max: 20" value="{{explode(' ',explode('-',$delivery_company->delivery_time)[1])[0]}}" title="{{translate('messages.maximum_delivery_time')}}">
                        ...
                        {{-- @if($delivery_company->self_delivery_system)
                        <div class="col-sm-{{$delivery_company->self_delivery_system?'4':'6'}}">
                            <div class="form-group mb-0">
                                <label class="input-label text-capitalize" for="title">{{translate('messages.delivery_charge')}}</label>
                                <input type="number" name="delivery_charge" step="0.01" min="0" max="100000" class="form-control" placeholder="100" value="{{$delivery_company->delivery_charge??'0'}}">
                            </div>
                        </div>
                        @endif --}}
                        @if($delivery_company->self_delivery_system)
                        <div class="col-sm-{{$delivery_company->self_delivery_system?'4':'6'}} col-12">
                            <div class="form-group mt-3">
                                ...
                                <input type="number" id="minimum_shipping_charge" min="0" max="99999999.99" step="0.01" name="minimum_delivery_charge" class="form-control shipping_input" value="{{isset($delivery_company->minimum_shipping_charge) ? $delivery_company->minimum_shipping_charge : ''}}">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-{{$delivery_company->self_delivery_system?'4':'6'}} col-12">
                            <div class="form-group mt-3">
                                ...
                                <input type="number" name="per_km_delivery_charge" step="0.01" min="0" max="100000" class="form-control" placeholder="100" value="{{$delivery_company->per_km_shipping_charge??'0'}}">
                            </div>
                        </div>
                        <div class="col-sm-{{$delivery_company->self_delivery_system?'4':'6'}} col-12">
                            <div class="form-group mt-3">
                                ...
                                <input type="number" name="maximum_shipping_charge" step="0.01" min="0" max="999999999" class="form-control" placeholder="10000" value="{{$delivery_company->maximum_shipping_charge??''}}">
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="col-sm-{{$delivery_company->self_delivery_system?'4':'6'}}">
                            <div class="form-group mb-0 p-2">
                                <label class="d-flex justify-content-between switch toggle-switch-sm text-dark" for="gst_status">
                                    ...
                                    <input type="checkbox" class="toggle-switch-input" name="gst_status" id="gst_status" value="1" {{$delivery_company->gst_status?'checked':''}}>
                                    <span class="toggle-switch-label">
                                        <span class="toggle-switch-indicator"></span>
                                    </span>
                                </label>
                                <input type="text" id="gst" name="gst" class="form-control" value="{{$delivery_company->gst_code}}" {{isset($delivery_company->gst_status)?'':'readonly'}}>
                            </div>
                        </div>
                        <div class="col-12">
        ...
        <div class="card mt-3">
            ...
            <div class="card-body" id="schedule">
                @include('delivery-partner-views.business-settings.partials._schedule', $delivery_company)
            </div>
        </div>
        @endif
    </div>
    ...
    <script>
        function restaurant_open_status(e) {
            Swal.fire({
                ...
                text: '{{$delivery_company->active ? translate('messages.you_want_to_temporarily_close_this_delivery_company') : translate('messages.you_want_to_open_this_delivery_company') }}',
                type: 'warning',
                ...
                if (result.value) {
                    $.get({
                        url: '{{route('partner.business-settings.update-active-status')}}',
                        contentType: false,
                        processData: false,
                        beforeSend: function () {
                            $('#loading').show();
        ...
        $('#add-schedule').on('submit', function (e) {
            ...
            $.post({
                url: '{{route('partner.business-settings.add-schedule')}}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
