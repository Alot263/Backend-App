@php($data=[])
<?php
foreach ($delivery_company->schedules as $schedule)
{
    ...
    <div class="schedult-date-content">
        @if(isset($data['1']) && count($data['1']))
            ...
            <div class="d-inline-flex align-items-center">
                ...
                <span class="dismiss--date" onclick="delete_schedule('{{route('partner.business-settings.remove-schedule',['delivery_company_schedule'=>$day['id']])}}')"><i class="tio-clear-circle-outlined"></i></span></span>
            </div>
            @endforeach
        @else
