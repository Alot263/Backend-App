...
@section('title',translate('messages.delivery_company_view'))
@push('css_or_js')
...
<div class="content container-fluid">
    <div class="page-header">
        <div class="d-flex flex-wrap justify-content-between">
            <h2 class="page-header-title text-capitalize my-2">
                ...
                <span>
                    {{translate('messages.my_delivery_company_info')}}
                </span>
            </h2>
            <div class="my-2">
                <a class="btn btn--primary" href="{{route('partner.shop.edit')}}"><i class="tio-edit"></i>{{translate('messages.edit_delivery_company_information')}}</a>
            </div>
        </div>
    </div>
    <div class="card border-0">
        <div class="card-body p-0">
            @if($shop->cover_photo)
            <div>
                <img class="my-restaurant-img" src="{{asset('storage/app/public/delivery_company/cover/'.$shop->cover_photo)}}" onerror="this.src='{{asset('public/assets/admin/img/900x400/img1.jpg')}}'">
            </div>
            @endif
            <div class="my-resturant--card">
                ...
                @else
                    <div class="my-resturant--avatar">
                        <img src="{{asset('storage/app/public/delivery_company/'.$shop->logo)}}" class="border" onerror="this.src='{{asset('public/assets/admin/img/160x160/img1.jpg')}}'" alt="">
                    </div>
                @endif
