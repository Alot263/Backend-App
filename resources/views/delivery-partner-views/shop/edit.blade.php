...
@section('title',translate('messages.edit_delivery_company'))
@push('css_or_js')
    <!-- Custom styles for this page -->
    <link href="{{asset('public/assets/admin')}}/partner/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
     <!-- Custom styles for this page -->
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <h2 class="page-header-title text-capitalize">
                <img class="w--26" src="{{asset('/public/assets/admin/img/delivery_company.png')}}" alt="public">
                <span>
                    {{translate('messages.edit')}} {{translate('messages.delivery_company')}} {{translate('messages.info')}}
                </span>
            </h1>
        </div>
        <form action="{{route('partner.shop.update')}}" method="post"
            ...
            <div class="row g-3">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">{{translate('messages.delivery_company')}} {{translate('messages.name')}} <span class="text-danger">*</span></label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-column pt-0">
                            <center class="my-auto py-4 py-xl-5">
                                <img class="delivery_company-banner" id="viewer"
                                onerror="this.src='{{asset('public/assets/admin/img/image-place-holder.png')}}'"
                                src="{{asset('storage/app/public/delivery_company/'.$shop->logo)}}" alt="Product thumbnail"/>
                            </center>
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-column pt-0">
                            <center class="my-auto py-4 py-xl-5">
                                <img class="delivery_company-banner" id="coverImageViewer"
                                onerror="this.src='{{asset('public/assets/admin/img/restaurant_cover.jpg')}}'"
                                src="{{asset('storage/app/public/delivery_company/cover/'.$shop->cover_photo)}}" alt="Product thumbnail"/>
                            </center>
                            <div class="custom-file">
            ...
            <div class="mt-3 justify-content-end btn--container">
                <a class="btn btn--danger text-capitalize" href="{{route('partner.shop.view')}}">{{translate('messages.cancel')}}</a>
