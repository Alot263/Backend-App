...
<div class="modal-body">
    <div class="d-flex flex-row align-items-center">
        @if (config('toggle_veg_non_veg') &&
            config('module.' . \App\CentralLogics\Helpers::get_delivery_company_data()->module->module_type)['veg_non_veg'])
            <span
        ...
        <div class="details pl-2">
            <a href="{{ route('partner.item.view', $product->id) }}"
                ...
                <div class="mb-3 text-dark">
                    ...
                    @if ($product->discount > 0 || \App\CentralLogics\Helpers::get_delivery_company_discount($product->delivery_company))
