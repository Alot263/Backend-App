<div class="d-flex flex-row cart--table-scroll">
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            $subtotal = 0;
            $addon_price = 0;
            $tax = \App\CentralLogics\Helpers::get_delivery_company_data()->tax;
            $discount = 0;
...
?>
<form action="{{ route('partner.pos.order') }}" id='order_place' method="post">
    @csrf
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id='payable_delivery_company_amount'>
                    @csrf
                    <div class="row">
...
<div class="modal fade" id="add-discount" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('partner.pos.discount') }}" method="post" class="row">
                    @csrf
...
<div class="modal fade" id="add-tax" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('partner.pos.tax') }}" method="POST" class="row" id="order_submit_form">
                    @csrf
                    <div class="form-group col-12">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                ?>
                <form id='delivery_address_delivery_company'>
                    @csrf
