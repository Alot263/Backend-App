                ...
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <div class="mt-2">
                        ...
                        <div class="hs-unfold float-right">
                            ...
                            <a class="btn btn-sm btn-primary" onclick="order_status_change_alert('{{route('partner.order.status',['id'=>$order['id'],'order_status'=>'processing'])}}','Change status to cooking ?')" href="javascript:">{{translate('messages.Proceed_for_cooking')}}</a>
                            @elseif ($order['order_status']=='processing')
                ...
                <div class="card mb-3 mb-lg-5">
                    ...
                    @foreach($order->details as $detail)
                        @if($detail->item)
                            <!-- Media -->
                                <div class="media">
                                    <a class="avatar avatar-xl mr-3" href="{{route('partner.item.view',$detail->item['id'])}}">
                                        <img class="img-fluid"
                        ...
                        <div class="row justify-content-md-end mb-3">
                            <div class="col-md-9 col-lg-8">
                                <dl class="row text-sm-right">
                                    ...
                                    <dd class="col-sm-6">
                                        - {{\App\CentralLogics\Helpers::format_currency($order['delivery_company_discount_amount'])}}</dd>
                                    ...
                                    <dd class="col-sm-6">{{\App\CentralLogics\Helpers::format_currency($sub_total+$del_c+$order['total_tax_amount']+$add_ons_cost-$order['coupon_discount_amount'] - $order['delivery_company_discount_amount'])}}</dd>
                                </dl>
                                <!-- End Row -->
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body row ff-emoji">
                    ...
                    <div class="row m-auto" id="printableArea">
                        @include('delivery-partner-views.pos.order.invoice')
                    </div>
...
@push('script_2')
    <script>
        ...
        function addDeliveryMan(id) {
            $.ajax({
                type: "GET",
                url: '{{url('/')}}/partner/orders/add-delivery-man/{{$order['id']}}/' + id,
