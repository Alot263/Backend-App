            ...
            @if ($order->delivery_company)
                <div class="text-center pt-4 mb-3">
                    <img class="invoice-logo" src="{{ asset('/public/assets/admin/img/invoice-logo.png') }}"
                        alt="">
                    <div class="top-info">
                        <h2 class="delivery_company-name">{{ $order->delivery_company->name }}</h2>
                        <div>
                            {{ $order->delivery_company->address }}
                        </div>
                        <div class="mt-1">
                            {{ translate('messages.phone') }} : {{ $order->delivery_company->phone }}
                        </div>
                    </div>
                </div>
            @endif
            ...
            <div class="checkout--info">
                <dl class="row text-right">
                    @if ($order->order_type != 'parcel')
                        ...
                        <dd class="col-6">
                            -
                            {{ \App\CentralLogics\Helpers::format_currency($order['delivery_company_discount_amount']) }}
                        </dd>
