                    ...
                    @foreach($orders as $key=>$order)
                        <tr class="status-{{$order['order_status']}} class-all">
                            ...
                            <td class="table-column-pl-0">
                                <a href="{{route('partner.pos.order-details',['id'=>$order['id']])}}">{{$order['id']}}</a>
                            </td>
                            ...
                            <td>
                                <a class="btn btn-sm btn-white"
                                           href="{{route('partner.pos.order-details',['id'=>$order['id']])}}"><i
...
@push('script_2')
    ...
    <script>
        ...
        function print_invoice(order_id) {
            $.get({
                url: '{{url('/')}}/delivery_company-panel/pos/invoice/'+order_id,
                dataType: 'json',
                beforeSend: function () {
                    $('#loading').show();
                },
