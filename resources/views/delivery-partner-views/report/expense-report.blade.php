    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            ...
            <div class="__page-header-txt mt-3">
                {{ translate('This report will show all the orders in which the delivery_company discount has been used. The delivery_company discounts are: Free delivery, Coupon discount & item discounts(partial according to order commission).') }}
            </div>
                ...
                <div class="search--button-wrapper">
                    ...
                    <div class="hs-unfold ml-3">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item" href="{{route('partner.report.expense-export', ['type'=>'excel',request()->getQueryString()])}}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                                    src="{{ asset('public/assets/admin') }}/svg/components/excel.svg"
                                    alt="Image Description">
                                {{ translate('messages.excel') }}
                            </a>
                            <a id="export-csv" class="dropdown-item" href="{{route('partner.report.expense-export', ['type'=>'csv',request()->getQueryString()])}}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                        ...
                        <tbody id="set-rows">
                            ...
                            <tr>
                                ...
                                <td class="text-center" >
                                        ...
                                        <a href="{{route('partner.order.details',['id'=>$exp['order_id']])}}">{{$exp['order_id']}}</a>
                                        @else
