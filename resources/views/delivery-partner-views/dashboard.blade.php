...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <div class="row g-2" id="order_stats">
                    @include('delivery-partner-views.partials._dashboard-order-stats',['data'=>$data])
                </div>
            </div>
        </div>
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">{{translate('messages.welcome')}}, {{auth('partner_employee')->user()->f_name}}.</h1>
...
@push('script')
    <script src="{{asset('public/assets/admin')}}/partner/chart.js/dist/Chart.min.js"></script>
    <script src="{{asset('public/assets/admin')}}/partner/chart.js.extensions/chartjs-extensions.js"></script>
    <script
        src="{{asset('public/assets/admin')}}/partner/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.min.js"></script>
@endpush
...
@push('script_2')
    ...
    <script>
        function order_stats_update(type) {
            ...
            $.post({
                url: '{{route('partner.dashboard.order-stats')}}',
                data: {
