...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-end">
                ...
                <div class="col-sm-auto">
                    <a class="btn btn--primary" href="{{route('partner.dashboard')}}">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <form action="{{env('APP_MODE')!='demo'?route('partner.profile.update'):'javascript:'}}" method="post" enctype="multipart/form-data" id="partner-settings-form">
                @csrf
                <!-- Card -->
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <label
                            ...
                            <img id="viewer"
                                 ...
                                 class="avatar-img"
                                 src="{{asset('storage/app/public/partner')}}/{{auth('partner')->check()?auth('partner')->user()->image:auth('partner_employee')->user()->image}}"
                                 alt="Image">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-sm-down-break">
                                        <input type="text" class="form-control" name="f_name" id="firstNameLabel"
                                               ...
                                               value="{{auth('partner')->check()?auth('partner')->user()->f_name:auth('partner_employee')->user()->f_name}}">
                                        <input type="text" class="form-control" name="l_name" id="lastNameLabel"
                                               ...
                                               value="{{auth('partner')->check()?auth('partner')->user()->l_name:auth('partner_employee')->user()->l_name}}">
                                    </div>
                                </div>
                            </div>
                            <!-- End Form Group -->
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="js-masked-input form-control" name="phone" id="phoneLabel"
                                           ...
                                           value="{{auth('partner')->check()?auth('partner')->user()->phone:auth('partner_employee')->user()->phone}}"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" class="form-control" name="email" id="newEmailLabel"
                                           value="{{auth('partner')->check()?auth('partner')->user()->email:auth('partner_employee')->user()->email}}"
                                           placeholder="{{translate('messages.enter_new_email_address')}}" aria-label="{{translate('messages.enter_new_email_address')}}">
                                </div>
                            </div>

                            <div class="d-flex justify-content-end">
                                <button type="button" onclick="@if(env('APP_MODE')!='demo') form_alert('partner-settings-form','{{translate('messages.you_want_to_update_user_info')}}') @else call_demo() @endif" class="btn btn--primary">{{translate('messages.save_changes')}}</button>
                            </div>
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        <!-- Form -->
                        <form id="changePasswordForm" action="{{env('APP_MODE')!='demo'?route('partner.profile.settings-password'):'javascript:'}}" method="post"
