...
@push('css_or_js')
    ...
    <link href="{{asset('public/assets/back-end')}}/partner/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
@endpush
...
@section('content')
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('partner.dashboard')}}">{{translate('messages.dashboard')}}</a></li>
                <li class="breadcrumb-item" aria-current="page">{{translate('messages.delivery_company')}}</li>
                    ...
                    <div class="card-body">
                        <div class="col-md-8 mt-4">
                            ...
                            <a class="btn btn-primary"
                               href="{{route('partner.profile.bankInfo')}}">{{translate('messages.edit')}}</a>
                        </div>
                    </div>
                </div>
            </div>
