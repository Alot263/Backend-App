    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="d-flex flex-wrap justify-content-between">
                ...
                <a href="{{route('partner.item.edit',[$product['id']])}}" class="btn btn--primary">
        ...
        <!-- End Card -->
        @if(\App\CentralLogics\Helpers::get_delivery_company_data()->reviews_section)
                    ...
                    <table class="table table-borderless table-thead-bordered">
                        <thead class="thead-light">
                            <tr>
                                ...
                                @if(\App\CentralLogics\Helpers::get_delivery_company_data()->module->module_type == 'food')
