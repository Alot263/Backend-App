...
@section('content')
    <div class="content container-fluid">
            ...
            <div class="card-body">
                ...
                <div class="jumbotron pt-1 mb-0 pb-4 bg-white">
                    ...
                    <p>{{ translate('3. Once you have downloaded and filled the format file, upload it in the form below and
                        submit.') }}</p>
                    <p>{{ translate('4. You can get delivery_company id, module id and unit id from their list, please input the right ids.') }}</p>
        ...
        <form class="product-form" action="{{route('partner.item.bulk-import')}}" method="POST"
