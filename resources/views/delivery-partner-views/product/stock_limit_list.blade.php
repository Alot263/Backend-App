        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-sm-auto">
                    <a href="{{route('partner.item.add-new')}}" class="btn btn--primary m-0 pull-right h--37px d-flex align-items-center justify-content-center"><i class="tio-add-circle"></i> {{translate('messages.add')}} {{translate('messages.new')}} {{translate('messages.item')}}</a>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body py-2">
                <form action="{{route('partner.item.stock-update')}}" method="post">
                    @csrf
...
<script>
    function update_quantity(val) {
        ...
        $.get({
            url: '{{url('/')}}/delivery_company-panel/item/get-variations?id='+val,
            dataType: 'json',
