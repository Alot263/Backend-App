...
@section('content')
@php($module_type = \App\CentralLogics\Helpers::get_delivery_company_data()->module->module_type)
                                ...
                                <div class="row" id="coba">
                                    @foreach ($product->images as $key => $photo)
                                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 spartan_item_wrapper">
                                            ...
                                            <a href="{{route('partner.item.remove-image',['id'=>$product['id'],'name'=>$photo])}}"
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="category_id" id="category-id" class="form-control js-select2-custom"
                                                onchange="getRequest('{{url('/')}}/delivery_company-panel/item/get-categories?parent_id='+this.value,'sub-categories')">
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="sub_category_id" id="sub-categories"
                                                ...
                                                onchange="getRequest('{{url('/')}}/delivery_company-panel/item/get-categories?parent_id='+this.value,'sub-sub-categories')">
                                    ...
                                    @if (isset($product->food_variations))
                                        @foreach (json_decode($product->food_variations,true) as $key_choice_options=>$item)
                                            ...
                                            @if (isset($item["price"]))
                                                ...
                                                @break
                                            @else
                                                @include('delivery-partner-views.product.partials._new_variations',['item'=>$item,'key'=>$key_choice_options+1])
                                            @endif
                                        @endforeach
                                    @endif
                                    </div>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-12">
                                    <div class="customer_choice_options" id="customer_choice_options">
                                        @include('delivery-partner-views.product.partials._choices',['choice_no'=>json_decode($product['attributes']),'choice_options'=>json_decode($product['choice_options'],true)])
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="variant_combination" id="variant_combination">
                                        @include('delivery-partner-views.product.partials._edit-combinations',['combinations'=>json_decode($product['variations'],true),'stock'=>$module_data['stock']])
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <select name="addon_ids[]" class="form-control js-select2-custom" multiple="multiple">
                                            @foreach(\App\Models\AddOn::where('delivery_company_id', \App\CentralLogics\Helpers::get_delivery_company_id())->orderBy('name')->get() as $addon)
                                                <option
...
<script>
    ...
    <script>
        ...
        $(document).ready(function () {
            setTimeout(function () {
                ...
                getRequest('{{url('/')}}/delivery_company-panel/item/get-categories?parent_id=' + category + '&&sub_category=' + sub_category, 'sub-categories');
                getRequest('{{url('/')}}/delivery_company-panel/item/get-categories?parent_id=' + sub_category + '&&sub_category=' + sub_sub_category, 'sub-sub-categories');
            }, 1000)
        });
    </script>
    ...
    <script>
        ...
        function combination_update() {
            ...
            $.ajax({
                type: "POST",
                url: '{{route('partner.item.variant-combination')}}',
    ...
    <script>
        $('#product_form').on('submit', function () {
            ...
            $.post({
                url: '{{route('partner.item.update',[$product['id']])}}',
                ...
                success: function (data) {
                    ...
                    if (data.errors) {
                        ...
                        setTimeout(function () {
                            location.href = '{{route('partner.item.list')}}';
                        }, 2000);
                    }
                }
            });
