        ...
        <div class="page-header">
            ...
            <div class="js-nav-scroller hs-nav-scroller-horizontal">
                <ul class="nav nav-tabs mb-3 border-0 nav--tabs">
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('partner.delivery-man.preview', ['id'=>$dm->id, 'tab'=> 'info'])}}"  aria-disabled="true">{{translate('messages.info')}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="{{route('partner.delivery-man.preview', ['id'=>$dm->id, 'tab'=> 'transaction'])}}"  aria-disabled="true">{{translate('messages.transaction')}}</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <table id="datatable"
                        ...
                        @foreach($digital_transaction as $k=>$dt)
                            <tr>
                                ...
                                <td><a href="{{route('partner.order.details',$dt->order_id)}}">{{$dt->order_id}}</a></td>
...
<script>
    ...
    $('#search-form').on('submit', function (e) {
            ...
            $.post({
                url: '{{route('partner.delivery-man.transaction-search')}}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
