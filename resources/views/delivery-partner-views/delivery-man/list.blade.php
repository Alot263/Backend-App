                ...
                <table id="columnSearchDatatable"
                    ...
                    @foreach($delivery_men as $key=>$dm)
                        <tr>
                            ...
                            <td>
                                <a class="media align-items-center" href="{{route('partner.delivery-man.preview',[$dm['id']])}}">
                            ...
                            <td>
                                <div class="btn--container justify-content-center">
                                    <a class="btn action-btn btn--primary btn-outline-primary" href="{{route('partner.delivery-man.edit',[$dm['id']])}}" title="{{translate('messages.edit')}}"><i class="tio-edit"></i>
                                    </a>
                                ...
                                <form action="{{route('partner.delivery-man.delete',[$dm['id']])}}" method="post" id="delivery-man-{{$dm['id']}}">
                                    @csrf @method('delete')
                                </form>
                            </td>
                        </tr>
...
@push('script_2')
    ...
    <script>
        $('#search-form').on('submit', function (e) {
            ...
            $.post({
                url: '{{route('partner.delivery-man.search')}}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
