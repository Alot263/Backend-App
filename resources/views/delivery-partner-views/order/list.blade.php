                        ...
                        @foreach($orders as $key=>$order)
                            <tr class="status-{{$order['order_status']}} class-all">
                                ...
                                <td class="table-column-pl-0">
                                    <a href="{{route('partner.order.details',['id'=>$order['id']])}}">{{$order['id']}}</a>
                                </td>
                                <td>
                                    <div>
                                ...
                                <td>
                                    @if($order->customer)
                                        ...
                                        href="{{route('partner.customer.view',[$order['user_id']])}}"> --}}
                                        <strong>
                                ...
                                <td>
                                    <div class="btn--container justify-content-center">
                                        <a class="btn btn-sm btn--warning btn-outline-warning action-btn" href="{{route('partner.order.details',['id'=>$order['id']])}}"><i class="tio-visible-outlined"></i></a>
                                        <a class="btn btn-sm btn--primary btn-outline-primary action-btn" target="_blank" href="{{route('partner.order.generate-invoice',[$order['id']])}}"><i class="tio-print"></i></a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
...
@push('script_2')
    ...
    <script>
        $('#search-form').on('submit', function () {
            ...
            $.post({
                url: '{{route('partner.order.search')}}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
