                ...
                <table id="columnSearchDatatable"
                    ...
                    @foreach($reviews as $key=>$review)
                        <tr>
                            ...
                            <td>
                                @if ($review->item)
                                <a class="media align-items-center" href="{{route('partner.item.view',[$review->item['id']])}}">
                                ...
                                <span class="ml-10"><a href="{{route('partner.order.details',['id'=>$review->order_id])}}">{{ translate('messages.order_id') }}: {{$review->order_id}}</a></span>
                                @else
