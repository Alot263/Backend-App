                        ...
                        <div class="search--button-wrapper justify-content-end">
                            ...
                            <div class="hs-unfold mr-2">
                                ...
                                <div id="usersExportDropdown"
                                    ...
                                    <a id="export-excel" class="dropdown-item" href="{{route('partner.category.export-categories', ['type'=>'excel'])}}">
                                        <img class="avatar avatar-xss avatar-4by3 mr-2"
                                                src="{{asset('public/assets/admin')}}/svg/components/excel.svg"
                                                alt="Image Description">
                                        {{translate('messages.excel')}}
                                    </a>
                                    <a id="export-csv" class="dropdown-item" href="{{route('partner.category.export-categories', ['type'=>'csv'])}}">
                                        <img class="avatar avatar-xss avatar-4by3 mr-2"
...
@push('script_2')
    ...
    <script>
        ...
        $('#dataSearch').on('submit', function (e) {
            ...
            $.post({
                url: '{{route('partner.category.search')}}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
