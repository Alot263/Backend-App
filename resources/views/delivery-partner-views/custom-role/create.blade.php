...
<div class="content container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('partner.custom-role.create')}}" method="post">
                @csrf
                ...
                <div class="check--item-wrapper mx-0">
                    ...
                    <div class="check-item">
                        <div class="form-group form-check form--check">
                            <input type="checkbox" name="modules[]" value="delivery_company_setup" class="form-check-input" id="delivery_company_setup">
                            <label class="form-check-label input-label qcont" for="delivery_company_setup">{{translate('messages.delivery_company')}} {{translate('messages.setup')}}</label>
                        </div>
                    </div>
                    @if (config('module.'.\App\CentralLogics\Helpers::get_delivery_company_data()->module->module_type)['add_on'])
                    <div class="check-item">
                        <div class="form-group form-check form--check">
                    ...
                    <div class="check-item">
                        <div class="form-group form-check form--check">
                            <input type="checkbox" name="modules[]" value="my_delivery_company" class="form-check-input"
                                    id="my_delivery_company">
                            <label class="form-check-label input-label qcont" for="my_delivery_company">{{translate('messages.my_shop')}}</label>
                        </div>
                    </div>
                    {{-- <div class="check-item">
                        <div class="form-group form-check form--check">
                            ...
                            <td>
                                <div class="btn--container justify-content-center">
                                    <a class="btn action-btn btn--primary btn-outline-primary"
                                        href="{{route('partner.custom-role.edit',[$r['id']])}}" title="{{translate('messages.edit')}} {{translate('messages.role')}}"><i class="tio-edit"></i>
                                    </a>
                                ...
                                <form action="{{route('partner.custom-role.delete',[$r['id']])}}"
...
@push('script_2')
    <script>
        $('#search-form').on('submit', function (e) {
            ...
            $.post({
                url: '{{route('partner.custom-role.search')}}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
