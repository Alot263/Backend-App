...
<div class="content container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('partner.custom-role.update',[$role['id']])}}" method="post">
                @csrf
                ...
                <div class="check--item-wrapper mx-0">
                    ...
                    <div class="check-item">
                        <div class="form-group form-check form--check">
                            <input type="checkbox" name="modules[]" value="delivery_company_setup" class="form-check-input"
                                    id="delivery_company_setup" {{in_array('delivery_company_setup',(array)json_decode($role['modules']))?'checked':''}}>
                            <label class="form-check-label qcont" for="delivery_company_setup">{{translate('messages.business')}} {{translate('messages.setup')}}</label>
                        </div>
                    </div>
                    ...
                    <div class="check-item">
                        <div class="form-group form-check form--check">
                            <input type="checkbox" name="modules[]" value="my_delivery_company" class="form-check-input"
                                    id="my_shop" {{in_array('my_delivery_company',(array)json_decode($role['modules']))?'checked':''}}>
                            <label class="form-check-label qcont" for="my_delivery_company">{{translate('messages.my_shop')}}</label>
                        </div>
                    </div>
                    {{-- <div class="check-item">
                        <div class="form-group form-check form--check">
