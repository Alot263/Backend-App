    ...
    <div class="content container-fluid">
        ...
        <div class="row g-3">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('partner.addon.delivery_company')}}" method="post">
                            @csrf
                                    ...
                                    <td>
                                        <div class="btn--container">
                                            <a class="btn action-btn btn--primary btn-outline-primary"
                                                    href="{{route('partner.addon.edit',[$addon['id']])}}" title="{{translate('messages.edit')}} {{translate('messages.addon')}}"><i class="tio-edit"></i></a>
                                        ...
                                        <form action="{{route('partner.addon.delete',[$addon['id']])}}"
