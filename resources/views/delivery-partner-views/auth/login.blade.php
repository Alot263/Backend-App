...
<?php
    if (env('APP_MODE') == 'demo') {
        $site_direction = session()->get('site_direction_partner');
    } else {
        $site_direction = session()->has('partner_site_direction') ? session()->get('partner_site_direction') : 'ltr';
    }
...
<head>
    ...
    <!-- Title -->
    <title>{{translate('messages.delivery_company')}} | {{translate('messages.login')}}</title>
    ...
    <link rel="stylesheet" href="{{asset('public/assets/admin')}}/css/partner.min.css">
    <link rel="stylesheet" href="{{asset('public/assets/admin')}}/partner/icon-set/style.css">
    <!-- CSS Front Template -->
...
<main id="content" role="main" class="main">
    ...
    <div class="auth-wrapper partner-login">
        <div class="auth-wrapper-left">
            <div class="auth-left-cont">
                ...
                <img onerror="this.src='{{asset('/public/assets/admin/img/favicon.png')}}'"
                     src="{{ asset('storage/app/public/business/' . $delivery_company_logo) }}" alt="public/img">
        ...
        <div class="auth-wrapper-right">
            ...
            <div class="auth-wrapper-form">
                <div class="auth-header">
                    <div class="mb-5">
                        <h2 class="title signin-txt">{{translate('messages.partner')}} {{translate('messages.sign_in')}}</h2>
                ...
                <!-- Form -->
                <form class="login_form" action="{{route('partner.auth.login')}}" method="post" id="partner_login_form"
                      style="display: none;">
                    @csrf
                    ...
                    <div class="toggle-login">
                        {{ translate('Login as Delivery Company Employee') }}? <span class="toggle-login-btn text-yellow"
                                                                          data-type="employee"
                                                                          target-login="Delivery Company Employee Sign in">{{ translate('login here') }}</span>
                    </div>
                </form>
                <!-- End Form -->
                <!-- Form -->
                <form class="login_form" action="{{route('partner.auth.employee.login')}}" method="post"
                    ...
                    <div class="toggle-login">
                        {{ translate('Login as Delivery Company Owner') }}? <span class="toggle-login-btn text-yellow"
                                                                       data-type="emloyee"
                                                                       target-login="Delivery Company Owner Sign in">{{ translate('messages.login here') }}</span>
                    </div>
                ...
                <div class="text-center">
                    <button class="btn btn-lg btn-block btn-white mb-4" type="button" id="owner_sign_in">
                        <span class="d-flex justify-content-center align-items-center">
                            {{translate('Sign in as Delivery Company Owner')}}
                        </span>
                    </button>
                    ...
                    <button class="btn btn-lg btn-block btn-white mb-4" type="button" id="employee_sign_in">
                        <span class="d-flex justify-content-center align-items-center">
                            {{translate('Sign in as Delivery Company Employee')}}
                        </span>
                    </button>
...
<script>
    ...
    $('#owner_sign_in').on('click', function () {
        ...
        $('.signin-txt').text("{{translate('messages.delivery_company')}} {{translate('owner')}} {{translate('messages.sign_in')}}")
    });
    $('#employee_sign_in').on('click', function () {
        ...
        $('#owner_sign_in').hide();
        $('#partner_login_form').hide();
        $('.signin-txt').text("{{translate('messages.delivery_company')}} {{translate('employee')}} {{translate('messages.sign_in')}}")
    });
...
@if(isset($recaptcha) && $recaptcha['status'] == 1)
    ...
    <script>
        $("#partner_login_form").on('submit', function (e) {
