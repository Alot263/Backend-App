...
@section('title', translate('messages.delivery_company_registration'))
@push('css_or_js')
                ...
                <div class="card __card mb-3">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row row-margin-top">
                            <div class="col-md-6 col-lg-6 col-sm-12">
                                <div class="form-group">
                                    <label class="input-label" for="address">{{ translate('messages.delivery_company') }}
                                        {{ translate('messages.address') }}</label>
                                    <textarea type="text" name="address" class="form-control __form-control"
                                        placeholder="{{ translate('messages.delivery_company') }} {{ translate('messages.address') }}"
                        ...
                        <div class="row row-margin-top">
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <label class="input-label pt-2">{{ translate('messages.delivery_company') }}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="input-label" for="latitude">{{ translate('messages.latitude') }} <span
                                            ...
                                            title="{{ translate('messages.delivery_company_lat_lng_warning') }}"><img
                                                src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                                alt="{{ translate('messages.delivery_company_lat_lng_warning') }}"></span></label>
    ...
    @push('script_2')
        ...
        <script>
            ...
            $(document).ready(function() {
                $('#module_id').select2({
                    ajax: {
                        url: '{{url('/')}}/delivery_company/get-all-modules/',
