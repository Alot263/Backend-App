...
@push('css_or_js')
    ...
    <link href="{{asset('public/assets')}}/partner/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
...
@push('script')
    <!-- Page level plugins -->
    <script src="{{asset('public/assets')}}/partner/datatables/jquery.dataTables.min.js"></script>
    <script src="{{asset('public/assets')}}/partner/datatables/dataTables.bootstrap4.min.js"></script>
