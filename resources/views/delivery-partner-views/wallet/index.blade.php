...
@section('title',translate('messages.delivery_company').' '.translate('messages.wallet'))
...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <h1 class="page-header-title">
            ...
            <span>
                {{translate('messages.delivery_company_wallet')}}
            </span>
        </h1>
    </div>
    <!-- Page Heading -->
        <div class="row g-2">
        <?php
            $wallet = \App\Models\DeliveryCompanyWallet::where('partner_id',\App\CentralLogics\Helpers::get_partner_id())->first();
            if(isset($wallet)==false){
                \Illuminate\Support\Facades\DB::table('delivery_company_wallets')->insert([
                    'partner_id'=>\App\CentralLogics\Helpers::get_partner_id(),
                    'created_at'=>now(),
                    'updated_at'=>now()
                ]);
                $wallet = \App\Models\DeliveryCompanyWallet::where('partner_id',\App\CentralLogics\Helpers::get_partner_id())->first();
            ...
            <div class="col-md-4">
                <div class="card h-100 card--bg-1">
                    ...
                    <div class="card-footer pt-0 bg-transparent border-0">
                        @if(\App\CentralLogics\Helpers::get_partner_data()->account_no==null || \App\CentralLogics\Helpers::get_partner_data()->bank_name==null)
    ...
    <div class="modal fade" id="balance-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('partner.wallet.withdraw-request')}}" method="post">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn--container justify-content-center">
                                    @if($wr->approved==0)
                                        {{-- <a href="{{route('partner.withdraw.close',[$wr['id']])}}"
                                ...
                                <form action="{{route('partner.wallet.close-request',[$wr['id']])}}"
