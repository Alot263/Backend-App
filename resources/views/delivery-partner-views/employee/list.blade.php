...
<div class="content container-fluid">
    <div class="page-header">
        <div class="d-flex flex-wrap justify-content-between align-items-center">
            ...
            <a href="{{route('partner.employee.add-new')}}" class="btn btn--primary mb-2">
            ...
            <div class="search--button-wrapper justify-content-end">
                ...
                <div class="hs-unfold mr-2">
                    ...
                    <div id="usersExportDropdown"
                        ...
                        <a id="export-excel" class="dropdown-item" href="{{route('partner.employee.export-employee', ['type'=>'excel'])}}">
                            <img class="avatar avatar-xss avatar-4by3 mr-2"
                                    src="{{asset('public/assets/admin')}}/svg/components/excel.svg"
                                    alt="Image Description">
                            {{translate('messages.excel')}}
                        </a>
                        <a id="export-csv" class="dropdown-item" href="{{route('partner.employee.export-employee', ['type'=>'csv'])}}">
                            <img class="avatar avatar-xss avatar-4by3 mr-2"
                            ...
                            <td>
                                ...
                                <div class="btn--container justify-content-center">
                                    <a class="btn action-btn btn--primary btn-outline-primary"
                                        href="{{route('partner.employee.edit',[$e['id']])}}" title="{{translate('messages.edit')}} {{translate('messages.Employee')}}"><i class="tio-edit"></i>
                                    </a>
                                ...
                                <form action="{{route('partner.employee.delete',[$e['id']])}}"
...
@push('script_2')
    <script>
        ...
        $('#search-form').on('submit', function (e) {
            ...
            $.post({
                url: '{{route('partner.employee.search')}}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
