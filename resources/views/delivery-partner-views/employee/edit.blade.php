...
<div class="content container-fluid">
    ...
    <!-- Content Row -->
    <form action="{{route('partner.employee.update',[$e['id']])}}" method="post" enctype="multipart/form-data" class="js-validate">
        @csrf
        <div class="card">
                        ...
                        <div class="card h-100">
                            <div class="card-body d-flex flex-column">
                                ...
                                <center class="mb-auto">
                                    ...
                                    src="{{asset('storage/app/public/partner')}}/{{$e['image']}}" alt="Employee thumbnail"/>
                                </center>
        ...
        $(".js-example-responsive").select2({
            ...
            <script>
                $('#reset_btn').click(function(){
                    $('#viewer').attr('src','{{asset('storage/app/public/partner')}}/{{$e['image']}}');
                })
            </script>
@endpush
