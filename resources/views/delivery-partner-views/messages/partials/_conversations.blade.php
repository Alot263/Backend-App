    ...
    <div class="card-footer border-0 conv-reply-form">
        ...
        <form action="javascript:" method="post" id="reply-form-vnd" enctype="multipart/form-data">
            ...
            <div class="quill-custom_">
                ...
                <button type="submit"
                 {{-- onclick="replyConvs('{{route('partner.message.delivery_company',['user_id'=>$user->id,'user_type'=>$user_type])}}')" --}}
...
<script>
    ...
    $('#reply-form-vnd').on('submit', function() {
        $('button[type=submit], input[type=submit]').prop('disabled',true);
            ...
            $.post({
                url: '{{ route('partner.message.delivery_company', ['user_id'=>$user->id,'user_type'=>$user_type]) }}',
