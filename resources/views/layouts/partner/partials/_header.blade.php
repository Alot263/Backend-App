            ...
            <div class="navbar-nav-wrap-content-right">
                ...
                <ul class="navbar-nav align-items-center flex-row">
                    <li class="nav-item max-sm-m-0">
                        <div class="hs-unfold">
                            <div>
                                @php($local = session()->has('partner_local')?session('partner_local'):'en')
                                            ...
                                            @if($data['status']==1)
                                                <li>
                                                    <a class="dropdown-item py-1"
                                                       href="{{route('partner.lang',[$data['code']])}}">
                                                        {{-- <img
                    ...
                    <li class="nav-item d-none d-sm-inline-block mr-4">
                        ...
                        <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker btn btn-icon btn-soft-secondary rounded-circle"
                               href="{{route('partner.message.list')}}">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="hs-unfold">
                                ...
                                <div class="cmn--media right-dropdown-icon d-flex align-items-center">
                                    ...
                                    <div class="avatar avatar-sm avatar-circle">
                                        <img class="avatar-img"
                                            ...
                                            src="{{asset('storage/app/public/partner')}}/{{\App\CentralLogics\Helpers::get_loggedin_user()->image}}"
                            ...
                            <div id="accountNavbarDropdown"
                                ...
                                <a class="dropdown-item" href="{{route('partner.profile.view')}}">
                                ...
                                <a class="dropdown-item" href="javascript:" onclick="Swal.fire({
                                    ...
                                    if (result.value) {
                                        ...
                                        location.href='{{route('partner.auth.logout')}}';
                                        @elseif (auth('partner_employee')->check())
                                        location.href='{{route('partner.auth.employee.logout')}}';
                                        @endif
                                    } else{
