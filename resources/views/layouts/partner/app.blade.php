...
<!-- Builder -->
@include('layouts.partner.partials._front-settings')
<!-- End Builder -->

<!-- JS Preview mode only -->
@include('layouts.partner.partials._header')
@include('layouts.partner.partials._sidebar')
<!-- END ONLY DEV -->
...
<!-- End Content -->
    ...
    <!-- Footer -->
@include('layouts.partner.partials._footer')
<!-- End Footer -->
...
<script>
    ...
    $(document).on('ready', function(){
        ...
        function setDirection(status) {
            ...
            $.get({
                    url: '{{ route('partner.site_direction') }}',
                    dataType: 'json',
                    data: {
                        status: status,
                    },
...
messaging
    ...
    .then(function () {
        ...
        subscribeTokenToTopic(response, "delivery_company_panel_{{$delivery_company_id}}_message");
        // $.ajaxSetup({
        //     headers: {
        ...
        // });
        // $.ajax({
        //     url: '{{ route('partner.delivery-company.token') }}',
        //     type: 'POST',
        //     data: {
        //         token: response
        //     },
...
fetch('https://iid.googleapis.com/iid/v1/' + token + '/rel/topics/' + topic, {
    ...
    function getUrlParameter(sParam) {
        ...
        function converationList() {
            $.ajax({
                url: "{{ route('partner.message.list') }}",
        ...
        function conversationView() {
            ...
            var user_id = getUrlParameter('user');
            var url= '{{url('/')}}/delivery_company-panel/message/view/'+conversation_id+'/' + user_id;
            $.ajax({
                url: url,
                success: function(data) {
        ...
        function check_order() {
            if(order_type){
                location.href = '{{url('/')}}/delivery_company-panel/order/list/'+order_type;
            }
            location.href = '{{url('/')}}/delivery_company-panel/order/list/all';
        }
