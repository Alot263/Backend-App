@php use App\CentralLogics\Helpers;use App\Models\Order; @endphp
    ...
    <aside
        ...
        <div class="navbar-vertical-container">
            <div class="navbar-brand-wrapper justify-content-between">
                <!-- Logo -->
                @php($delivery_company_logo = \App\Models\BusinessSetting::where(['key' => 'logo'])->first()->value)
                <a class="navbar-brand" href="{{ route('admin.dashboard') }}" aria-label="Front">
                    <img class="navbar-brand-logo initial--36"
                         onerror="this.src='{{ asset('public/assets/admin/img/160x160/img2.jpg') }}'"
                         src="{{ asset('storage/app/public/business/' . $delivery_company_logo) }}" alt="Logo">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                                    ...
                                    <a class="nav-link" href="{{ route('admin.order.list', ['all']) }}"
                                       title="{{ translate('messages.all') }} {{ translate('messages.orders') }}">
                                        ...
                                        <span class="badge badge-soft-info badge-pill ml-1">
                                            {{ Order::StoreOrder()->module(Config::get('module.current_module_id'))->count() }}
                                        </span>
                                    </span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Request::is('admin/order/list/scheduled') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('admin.order.list', ['scheduled']) }}"
                                       title="{{ translate('messages.scheduled_orders') }}">
                                        ...
                                        <span class="badge badge-soft-info badge-pill ml-1">
                                            {{ Order::Scheduled()->StoreOrder()->module(Config::get('module.current_module_id'))->count() }}
                                        </span>
                                    </span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Request::is('admin/order/list/pending') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.order.list', ['pending']) }}"
                                       title="{{ translate('messages.pending') }} {{ translate('messages.orders') }}">
                                        ...
                                        <span class="badge badge-soft-info badge-pill ml-1">
                                            {{ Order::Pending()->OrderScheduledIn(30)->StoreOrder()->module(Config::get('module.current_module_id'))->count() }}
                                        </span>
                                    </span>
                                    </a>
                                </li>
                                    ...
                                    <a class="nav-link " href="{{ route('admin.order.list', ['accepted']) }}"
                                       title="{{ translate('messages.accepted_orders') }}">
                                        ...
                                        <span class="badge badge-soft-success badge-pill ml-1">
                                            {{ Order::AccepteByDeliveryman()->OrderScheduledIn(30)->StoreOrder()->module(Config::get('module.current_module_id'))->count() }}
                                        </span>
                                    </span>
                                    </a>
                                </li>
                                    ...
                                    <a class="nav-link " href="{{ route('admin.order.list', ['processing']) }}"
                                       title="{{ translate('messages.processing_orders') }}">
                                        ...
                                        <span class="badge badge-soft-warning badge-pill ml-1">
                                            {{ Order::Preparing()->OrderScheduledIn(30)->StoreOrder()->module(Config::get('module.current_module_id'))->count() }}
                                        </span>
                                    </span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Request::is('admin/order/list/item_on_the_way') ? 'active' : '' }}">
                                    <a class="nav-link text-capitalize"
                                       ...
                                       title="{{ translate('messages.order_on_the_way') }}">
                                        ...
                                        <span class="badge badge-soft-warning badge-pill ml-1">
                                            {{ Order::ItemOnTheWay()->OrderScheduledIn(30)->StoreOrder()->module(Config::get('module.current_module_id'))->count() }}
                                        </span>
                                    </span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Request::is('admin/order/list/delivered') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.order.list', ['delivered']) }}"
                                       title="{{ translate('messages.delivered_orders') }}">
                                        ...
                                        <span class="badge badge-soft-success badge-pill ml-1">
                                            {{ Order::Delivered()->StoreOrder()->module(Config::get('module.current_module_id'))->count() }}
                                        </span>
                                    </span>
                                    </a>
                                </li>
                                    ...
                                    <a class="nav-link " href="{{ route('admin.order.list', ['canceled']) }}"
                                       title="{{ translate('messages.canceled_orders') }}">
                                        ...
                                        <span class="badge badge-soft-warning bg-light badge-pill ml-1">
                                            {{ Order::Canceled()->StoreOrder()->module(Config::get('module.current_module_id'))->count() }}
                                        </span>
                                    </span>
                                    </a>
                                </li>
                                    ...
                                    <a class="nav-link " href="{{ route('admin.order.list', ['failed']) }}"
                                       title="{{ translate('messages.payment_failed_orders') }}">
                                        ...
                                        <span class="badge badge-soft-danger bg-light badge-pill ml-1">
                                            {{ Order::failed()->StoreOrder()->module(Config::get('module.current_module_id'))->count() }}
                                        </span>
                                    </span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Request::is('admin/order/list/refunded') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.order.list', ['refunded']) }}"
                                       title="{{ translate('messages.refunded_orders') }}">
                                        ...
                                        <span class="badge badge-soft-danger bg-light badge-pill ml-1">
                                            {{ Order::Refunded()->StoreOrder()->module(Config::get('module.current_module_id'))->count() }}
                                        </span>
                                    </span>
                                    </a>
                                </li>
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{ Request::is('admin/refund/requested') ||  Request::is('admin/refund/rejected') ||Request::is('admin/refund/refunded') ? 'active' : '' }}">
                                    ...
                                    <span class="badge badge-soft-danger badge-pill ml-1">
                                        {{ Order::Refund_requested()->StoreOrder()->module(Config::get('module.current_module_id'))->count() }}
                                    </span>
                                </span>
                                    </a>
                                </li>
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle"
                               title="{{ translate('messages.delivery_company') }} {{ translate('messages.section') }}">{{ translate('messages.delivery_company') }}
                            {{ translate('messages.management') }}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>

                    @if (Helpers::module_permission_check('delivery_company'))

                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/delivery-company/pending-requests') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="{{ route('admin.delivery-company.pending-requests') }}"
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/delivery-company/add') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="{{ route('admin.delivery-company.add') }}"
                               title="{{ translate('messages.add') }} {{ translate('messages.delivery_company') }}">
                                <span class="tio-add-circle nav-icon"></span>
                                <span class="text-truncate">
                            {{ translate('messages.add') }} {{ translate('messages.delivery_company') }}
                        </span>
                            </a>
                        </li>
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/deliver-company/list') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="{{ route('admin.delivery-company.list') }}"
                               title="{{ translate('messages.delivery_companies') }} {{ translate('messages.list') }}">
                                <span class="tio-layout nav-icon"></span>
                                <span class="text-truncate">{{ translate('messages.delivery_companies') }}
                                    {{ translate('list') }}</span>
                            </a>
                        </li>
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/deliver-company/bulk-import') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.delivery-company.bulk-import') }}"
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/deliver-company/bulk-export') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.delivery-company.bulk-export-index') }}"
