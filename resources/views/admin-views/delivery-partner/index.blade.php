...
@section('title',translate('messages.add_delivery_company'))
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{translate('messages.add')}} {{translate('messages.new')}} {{translate('messages.delivery_company')}}
                </span>
            </h1>
        </div>
        <!-- End Page Header -->
        <form action="{{route('admin.delivery-company.delivery-company')}}" method="post" enctype="multipart/form-data" class="js-validate" id="partner_form">
            @csrf
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title m-0 d-flex align-items-center">
                                <img class="mr-2 align-self-start w--20" src="{{asset('public/assets/admin/img/deliveryman.png')}}" alt="instructions">
                            ...
                            <div class="row g-3 mb-0">
                                <div class="col-lg-6 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="{{translate('messages.delivery_company')}} {{translate('messages.name')}}" value="{{old('name')}}" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="address">{{translate('messages.delivery_company')}} {{translate('messages.address')}}</label>
                                        <textarea type="text" name="address" class="form-control h--45px" placeholder="{{translate('messages.delivery_company')}} {{translate('messages.address')}}" required >{{old('address')}}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="d-flex flex-column">
                                        ...
                                        <center class="py-4 my-auto">
                                            ...
                                            src="{{asset('public/assets/admin/img/100x100/6.png')}}" alt="{{translate('delivery_company_logo')}}"/>
                                        </center>
...
@push('script_2')
    ...
    <script>
        ...
        <script>
            ...
            $('#module_id').select2({
                    ajax: {
                         url: '{{url('/')}}/delivery-company/get-all-modules',
