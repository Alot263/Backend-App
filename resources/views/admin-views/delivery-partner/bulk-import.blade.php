...
@section('title',translate('Delivery Company Bulk Import'))
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{translate('messages.delivery_companies')}} {{translate('messages.bulk_import')}}
                </span>
            </h1>
        </div>
        <!-- Content Row -->
        <div class="card">
            <div class="card-body p-2">
                ...
                <div class="jumbotron pt-1 mb-0 pb-4 bg-white">
                    ...
                    <p>{{ translate('4. After uploading delivery companies you need to edit them and set delivery company`s logo and cover.') }}</p>
                    ...
                    <p>{{ translate('7. You can upload your delivery company images in delivery company folder from gallery, and copy image`s path.') }}</p>

                    <p>{{ translate('8. Default password for delivery company is 12345678.') }}</p>
                ...
                <div class="text-center pb-4">
                    ...
                    <div class="btn--container justify-content-center export--template-btns">
                        <a href="{{asset('public/assets/delivery_companies_bulk_format.xlsx')}}" download="" class="btn btn-dark">{{ translate('messages.Template with Existing Data') }}</a>
                        <a href="{{asset('public/assets/delivery_companies_bulk_format_nodata.xlsx')}}" download="" class="btn btn-dark">{{ translate('messages.Template without Data') }}</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="card mt-3">
            <div class="card-body">
                <form class="product-form" action="{{route('admin.delivery-company.bulk-import')}}" method="POST"
                      enctype="multipart/form-data">
                    @csrf
                    <h4 class="mb-3">{{ translate('Import Delivery Companies File') }}</h4>
