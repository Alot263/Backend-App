...
@section('title',translate('denied_delivery_companies'))
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title"><i
                    class="tio-filter-list"></i> {{translate('messages.denied_delivery_companies')}}</h1>
                ...
                <div class="col-md-12">
                    <div class="js-nav-scroller hs-nav-scroller-horizontal mt-2">
                        ...
                        <ul class="nav nav-tabs mb-3 border-0 nav--tabs">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.delivery_company.pending-requests') }}"
                                   aria-disabled="true">{{translate('messages.pending_delivery_companies')}}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('admin.delivery_company.deny-requests') }}"
                                   aria-disabled="true">{{translate('messages.denied_delivery_companies')}}</a>
                            </li>
                        </ul>
                        <!-- End Nav -->
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-header py-2">
                <div class="search--button-wrapper">
                    <h5 class="card-title">{{translate('messages.delivery_companies')}} {{translate('messages.list')}}
                        <span class="badge badge-soft-dark ml-2" id="itemCount">{{$delivery_companies->total()}}</span>
                    </h5>
                ...
                <table id="columnSearchDatatable"
                    ...
                    @foreach($delivery_companies as $key=>$delivery_company)
                        <tr>
                            ...
                            <td>
                                @if($delivery_company->partner->status == 0)
