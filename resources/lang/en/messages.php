<?php return array (
  ...
  'my_shop' => 'My Store',
  'my_delivery_company' => 'My Delivery Company',
  'new' => 'New',
  ...
  'you_want_to_change_this_delivery_company_status' => 'You want to change status for this delivery company status?',
  ...
  'delivery_partner_information' => 'Delivery Partner information',
  'account' => 'Account',
  'partner' => 'Partner',
  ...
  'total_delivery_companies' => 'Total delivery companies',
  'active_stores' => 'Active stores',
  'active_deliery_companies' => 'Active delivery companies',
  'inactive_stores' => 'Inactive stores',
  'newly_joined_stores' => 'Newly joined stores',
  'newly_joined_delivery_companies' => 'Newly joined delivery companies',
  'total_transactions' => 'Total transactions',
  'total_store_withdraws' => 'Total store withdraws',
  'total_delivery_company_withdraws' => 'Total delivery company withdraws',
  ...
  'ex_:_Search_Store_Name' => 'Ex : Search Store Name',
  'ex_:_Search_Delivery_Company_Name' => 'Ex : Search Delivery Company Name',
  ...
  'denied_partners' => 'Denied partners',
  'add_delivery_company' => 'Add delivery company',
  'new_delivery_companies' => 'New Delivery Companies',
  'delivery_companies' => 'Delivery Companies',
  'delivery_company' => 'Delivery Company',
  'delivery_company_information' => 'Delivery company information',
  ...
  'add_delivery_partner' => 'Add partner',
  ...
  'pending_partners' => 'Pending parners',
  ...
  'You have already added maximum numbers of banner image' => 'You have already added maximum numbers of banner image',
  ...
  'inactive_delivery_companies' => 'Inactive delivery companies',
  'export_delivery_companies' => 'Export delivery companies',
  'Delivery Company Bulk Import' => 'Delivery Company Bulk Import',
  '4. After uploading delivery companies you need to edit them and set delivery company`s logo and cover.' => '4. After uploading delivery companies you need to edit them and set delivery company`s logo and cover.',
  '7. You can upload your delivery company images in delivery company folder from gallery, and copy image`s path.' => '7. You can upload your delivery company images in delivery company folder from gallery  and copy image`s path.',
  '8. Default password for delivery company is 12345678.' => '8. Default password for delivery company is 12345678.',
  'Import Delivery Companies File' => 'Import Delivery Companies File',
  'delivery_company_logo' => 'Delivery company logo',
  'delivery_company_lat_lng_warning' => 'Delivery company lat lng warning',
  'You want to remove this delivery company' => 'You want to remove this delivery company',
  'Login as Delivery Company Employee' => 'Login as Delivery Company Employee',
  'Login as Delivery Company Owner' => 'Login as Delivery Company Owner',
  'Sign in as Delivery Company' => 'Sign in as Delivery Company',
  'Sign in as Delivery Company Employee' => 'Sign in as Delivery Company Employee',
  'Sign in as Delivery Company Owner' => 'Sign in as Delivery Company Owner',
  'Report' => 'Report',
  'This report will show all the orders in which the delivery_company discount has been used. The delivery_company discounts are: Free delivery, Coupon discount & item discounts(partial according to order commission).' => 'This report will show all the orders in which the delivery company discount has been used. The delivery company discounts are: Free delivery  Coupon discount & item discounts(partial according to order commission).',
  'delivery_company_wallet' => 'Delivery company wallet',
  'delivery_company_view' => 'Delivery company view',
  'my_delivery_company_info' => 'My delivery company info',
  'edit_delivery_company_information' => 'Edit delivery company information',
  'delivery_company_temporarily_closed_title' => 'Delivery company temporarily closed title',
  'you_want_to_temporarily_close_this_delivery_company' => 'You want to temporarily close this delivery company',
